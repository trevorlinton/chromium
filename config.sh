...
#./src/build/gyp_chromium -Dffmpeg_branding=Chrome -Dproprietary_codecs=1 -Dtarget_arch=x64 --no-circular-check src/content/content.gyp
./src/build/gyp_chromium -Dffmpeg_branding=Chrome -Dproprietary_codecs=1 -Dtarget_arch=ia32 --no-circular-check src/content/content.gyp
